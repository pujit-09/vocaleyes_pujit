...
ocr_model = OCR(detect=True)  # detect=True enables Tamil + English detection
...
def pil_from_bytes(image_bytes):
    ...
    # ---------------------------
    # ✅ Preprocessing for draw/canvas images
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    # Adaptive threshold for black strokes on white background
